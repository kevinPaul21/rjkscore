        ...
        return favoriteRepository.findByUser(user).stream()
                .map(fav -> {
                    ...
                    switch (type) {
                        ...
                        case "csgo_game_event" -> itemData = pandaScoreApiClient.getCsgoGameEvents(id);
                        case "csgo_game_round" -> itemData = pandaScoreApiClient.getCsgoGameRounds(id);
                        case "csgo_player_stat" -> itemData = pandaScoreApiClient.getCsgoPlayerStats();
                        case "csgo_team_stat" -> itemData = pandaScoreApiClient.getCsgoTeamStats();
                        case "csgo_tournament_stat" -> itemData = pandaScoreApiClient.getCsgoTournamentStats();
                        ...
                        case "dota2_ability" -> itemData = pandaScoreApiClient.getDota2Ability(id);
                        case "dota2_item" -> itemData = pandaScoreApiClient.getDota2Item(id);
                        case "dota2_hero" -> itemData = pandaScoreApiClient.getDota2Hero(id);
                        ...
                        case "lol_league" -> itemData = pandaScoreApiClient.getLolLeagues(); // No hay getLolLeague(id)
                        case "lol_series_team" -> itemData = pandaScoreApiClient.getLolSeriesTeams(id);
                        ...
                        case "valorant_league" -> itemData = pandaScoreApiClient.getValorantLeagues(); 
                        case "league" -> itemData = pandaScoreApiClient.getLeague(id);
                        case "match_opponents" -> itemData = pandaScoreApiClient.getMatchOpponents(id);
